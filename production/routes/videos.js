...
router.get('/random', passport_1.default.authenticate('jwt', { session: false }), videos_1.randomVideo);
router.get('/recomendations/:id', passport_1.default.authenticate('jwt', { session: false }), videos_1.recomendVideos);
router.get('/videos/search_results/:query', passport_1.default.authenticate('jwt', { session: false }), videos_1.searchResuts);
